...
$requirements = [ordered]@{
    ...
    'permanent goal' = 'complete all Space Age research and sustainably produce and consume 1,000,000 science packs per minute with 100% unattended automation'
    ...
    'mechanical hook boundary' = 'Hooks enforce only mechanical facts'
    'hooks do not own judgment' = 'Hooks do not own judgment'
    ...
    'latest operator message wins' = 'The latest operator message always wins'
    'ordinary request suspends continuation' = 'ordinary operator request suspends automatic continuation'
    'persistent hook bypass' = '`stop hooks` makes every project hook a persistent no-op'
    'destructive action protection' = 'protection against destructive actions'
    'tested pushed acceptance' = 'acceptance admission for the exact tested and pushed commit'
    'replacement evidence' = 'canonical review, recorded root cause, and committed failing proof'
    'repeated evidence no progress' = 'repeating the same completion, blocker, or support work does not count'
    'hook failure boundary' = 'fail open for support work and fail closed only for destructive actions and acceptance admission'
    ...
    'resume interrupted batch' = 'resume the interrupted batch automatically'
    ...
    'circuit blocks acceptance only' = 'blocks only another acceptance attempt'
    'production work remains available' = 'Review, documentation, tests, implementation, and builds remain available'
    ...
    'live rcon root cause authority' = 'For the current running game, begin root-cause analysis with direct live RCON evidence'
    'historical evidence boundary' = 'A previous attempt log cannot establish the current game root cause'
    'factorio system trace' = 'Trace the complete Factorio path from producer through connections and transport to the blocked consumer'
    'observation inference boundary' = 'Label direct game observations separately from inferences'
    'permanent missing diagnostic' = 'If the permanent live diagnostics cannot observe a required link, add a read-only repository diagnostic with a committed test'
    ...
    'permanent goal report' = 'Permanent goal progress:'
    'permanent goal denominator' = 'every finite enabled non-hidden live technology'
    ...
    'gameplay movement circuit' = 'Gameplay movement circuit'
    ...
    'forbid another acceptance loop' = 'Do not make another acceptance attempt'
